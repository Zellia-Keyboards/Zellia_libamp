...
static const USB_Descriptor_HIDReport_Datatype_t PROGMEM SharedReport[] = {
    ...
    HID_RI_USAGE_PAGE (8, 0x59),
    HID_RI_USAGE (8, 0x01),
    HID_RI_COLLECTION (8, 0x01),
        /* Lamp Array Attributes Report */
        HID_RI_REPORT_ID (8, REPORT_ID_LIGHTING_LAMP_ARRAY_ATTRIBUTES),
        HID_RI_USAGE (8, 0x02),
        HID_RI_COLLECTION (8, 0x02),
            HID_RI_USAGE         (8, 0x03),
            ...
            HID_RI_USAGE         (8, 0x08),
            HID_RI_LOGICAL_MINIMUM(8, 0),
            HID_RI_LOGICAL_MAXIMUM(32, 2147483647),
            HID_RI_REPORT_SIZE   (8, 32),
            HID_RI_REPORT_COUNT  (8, 5),
            HID_RI_FEATURE       (8, HID_IOF_CONSTANT | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE),
        HID_RI_END_COLLECTION(0),
        /* Lamp Attributes Request Report */
        HID_RI_REPORT_ID       (8, REPORT_ID_LIGHTING_LAMP_ATTRIBUTES_REQUEST),
        HID_RI_USAGE           (8, 0x20),
        HID_RI_COLLECTION      (8, 0x02),
            HID_RI_USAGE         (8, 0x21),
            HID_RI_LOGICAL_MINIMUM(8, 0),
        ...
        HID_RI_REPORT_ID       (8, REPORT_ID_LIGHTING_LAMP_ATTRIBUTES_RESPONSE),
        HID_RI_USAGE           (8, 0x22),
        HID_RI_COLLECTION      (8, 0x02),
            HID_RI_USAGE         (8, 0x21),
            HID_RI_LOGICAL_MINIMUM(8, 0),
        ...
        HID_RI_REPORT_ID       (8, REPORT_ID_LIGHTING_LAMP_MULTI_UPDATE),
        HID_RI_USAGE           (8, 0x50),
        HID_RI_COLLECTION      (8, 0x02),
            HID_RI_USAGE         (8, 0x03),
            HID_RI_USAGE         (8, 0x55),
        ...
        HID_RI_REPORT_ID       (8, REPORT_ID_LIGHTING_LAMP_RANGE_UPDATE),
        HID_RI_USAGE           (8, 0x60),
        HID_RI_COLLECTION      (8, 0x02),
            HID_RI_USAGE         (8, 0x55),
            HID_RI_LOGICAL_MINIMUM(8, 0),
        ...
        HID_RI_REPORT_ID      (8, REPORT_ID_LIGHTING_LAMP_ARRAY_CONTROL),
        HID_RI_USAGE          (8, 0x70),
        HID_RI_COLLECTION     (8, 0x02),
            HID_RI_USAGE        (8, 0x71),
            HID_RI_LOGICAL_MINIMUM(8, 0),
